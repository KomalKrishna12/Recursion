...
public class Q5_Print_all_permutations_of_string_and_array {
    public static void main(String[] args) {
        ...
        // when small array list size equal to array size add that into ans means we got one of the 
        // permutation
    ...
    boolean[] map){
        ...
        // if that is false then we can add it into sl and mark it true and call for next
